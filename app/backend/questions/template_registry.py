...
TEMPLATES: list[QuestionTemplate] = [
    ...
    QuestionTemplate(
        id="TPL-MULTIPLICATION-WORD-PROBLEM",
        template_type="multiplication_word_problem",
        question_type=QuestionType.WORD_PROBLEM,
        subject="Mathematics",
        grade="III",
        ...
        marks=2.0,
        difficulty_range=(2, 3),
        variables={"a": "2_digit_number", "b": "1_digit_number"},
        operation="multiplication",
        answer_expression="a * b",
        text_template=(
            "There are {a} items in each box. If there are {b} boxes, "
            "how many items are there altogether?"
        ),
        answer_type="numeric",
    ),
    QuestionTemplate(
        id="TPL-MULTIPLICATION-ARITHMETIC",
        template_type="multiplication_arithmetic",
        question_type=QuestionType.ARITHMETIC,
        subject="Mathematics",
        grade="III",
        topic="Multiplication",
    ...
    QuestionTemplate(
        id="TPL-MULTIPLICATION-FILL-BLANK",
        template_type="multiplication_fill_blank",
        question_type=QuestionType.FILL_BLANK,
        subject="Mathematics",
        grade="III",
        topic="Multiplication",
        ...
        difficulty_range=(1, 2),
        variables={"a": "1_digit_number", "b": "1_digit_number"},
        operation="multiplication_fill_blank",
        answer_expression="a * b",
        text_template="{a} x ___ = {c}",
        answer_type="numeric",
    ),
]
